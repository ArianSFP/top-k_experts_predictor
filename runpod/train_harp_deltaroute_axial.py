#!/usr/bin/env python3
"""Train the structured layer-axis HARP-DeltaRoute translator."""
...
from harp_rtt.axial_route import AxialRouteTrajectory  # noqa: E402
...
def build_trajectory(parent: Any, static: Any) -> AxialRouteTrajectory:
