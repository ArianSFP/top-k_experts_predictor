...
1. Run `pytest -q tests/test_harp8*.py`.
...
6. For any level-2 forecaster or reranker, prove that each training request was excluded from the fitted base model and that level-2 train/validation request IDs are disjoint.
